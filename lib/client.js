...
function injectStyle() {
  ...
  style.textContent = [
    ...
    '[data-dsh-anchors-status]{position:absolute;left:40px;bottom:8px;z-index:4;box-sizing:border-box;max-width:min(280px,calc(100vw - 48px));padding:4px 8px;border-radius:8px;background:var(--dsw-alias-bg-float,#fff);color:var(--dsw-alias-label-secondary,#666);font-size:12px;line-height:18px;white-space:nowrap;pointer-events:none;box-shadow:0 4px 16px rgba(0,0,0,.1),0 0 0 1px rgba(0,0,0,.04);}',
