 ...
 * node's `[data-chat-anchor-key]` row. Opening a session drains
 * `session.loadOlder()` so the rail lists the full history.
 *
 * Mechanism notes:
...
const zh = {
  ...
  'styleTitle': '锚点风格',
  'styleDesc': '默认 Codex 左侧短横线。DeepSeek 右侧等长横线仅在需要时再开。',
  'styleCodex': 'Codex（左侧）',
...
const en = {
  ...
  'styleDesc': 'Codex left-rail by default. Turn on the DeepSeek right rail only if you prefer it.',
...
/** Normalize a stored value to one of the two rail styles. */
function normalizeStyle(value) {
  return value === 'deepseek' ? 'deepseek' : DEFAULT_STYLE
}
...
/** Current rail style (`codex` | `deepseek`). */
function getStyle() {
  return cachedStyle
}
...
/** Pick style from a settings-scope snapshot, else the local cache. */
function styleFromSnapshot(snapshot) {
  if (snapshot?.status === 'ready' && snapshot.value !== undefined && snapshot.value !== null) {
    return normalizeStyle(snapshot.value[STYLE_FIELD])
  }
  return readLocalStyle()
}
...
function setRailStyle(style) {
  ...
  if (styleScope !== undefined && typeof styleScope.set === 'function') {
    void styleScope.set(STYLE_FIELD, next).catch((error) => {
...
function injectStyle() {
  ...
  style.textContent = [
    ...
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"]{left:8px;width:36px;align-items:flex-start;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list]{flex:0 1 auto;margin:auto 0;min-height:0;max-height:100%;width:36px;display:flex;flex-direction:column;align-items:flex-start;gap:4px;padding:6px 0;overflow-y:auto;overflow-x:hidden;scrollbar-width:none;pointer-events:auto;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-item]{box-sizing:border-box;display:flex;align-items:center;width:36px;height:11px;margin:0;padding:0;border:0;background:transparent;cursor:pointer;outline:none;box-shadow:none;-webkit-tap-highlight-color:transparent;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-label]{display:none!important;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-tick]{display:block;width:8px;height:1.5px;border-radius:1px;background:var(--dsh-anchors-tick);transform-origin:left center;transition:width .14s ease,height .14s ease,background-color .14s ease;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-item][data-active] [data-dsh-anchors-tick]{width:16px;height:2px;background:var(--dsh-anchors-tick-strong);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-active] [data-dsh-anchors-tick]{width:8px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="0"] [data-dsh-anchors-tick]{width:32px;height:2.5px;background:var(--dsh-anchors-tick-strong);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="1"] [data-dsh-anchors-tick]{width:22px;height:2px;background:var(--dsh-anchors-tick-mid);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="2"] [data-dsh-anchors-tick]{width:15px;height:1.5px;background:var(--dsh-anchors-tick-mid);opacity:.85;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="3"] [data-dsh-anchors-tick]{width:11px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="4"] [data-dsh-anchors-tick]{width:8px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="codex"] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="5"] [data-dsh-anchors-tick]{width:6px;height:1.5px;background:var(--dsh-anchors-tick);opacity:.8;}',
    ...
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"]{align-items:flex-end;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-list]{box-sizing:border-box;flex:0 1 auto;margin:auto 0;min-height:0;max-height:100%;width:20px;display:flex;flex-direction:column;align-items:stretch;gap:6px;padding:8px 0;overflow-y:auto;overflow-x:hidden;scrollbar-width:none;pointer-events:auto;border-radius:12px;background:transparent;transition:width .16s ease,padding .16s ease,background-color .16s ease,box-shadow .16s ease;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-list]:hover,[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-list]:focus-within{width:228px;padding:8px 10px 8px 12px;background:var(--dsh-anchors-ds-panel-bg);box-shadow:var(--dsh-anchors-ds-panel-shadow);}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-item]{box-sizing:border-box;display:flex;align-items:center;justify-content:flex-end;gap:0;width:100%;height:14px;margin:0;padding:0;border:0;background:transparent;cursor:pointer;outline:none;box-shadow:none;-webkit-tap-highlight-color:transparent;transition:height .16s ease,gap .16s ease;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-list]:hover [data-dsh-anchors-item],[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-list]:focus-within [data-dsh-anchors-item]{height:26px;gap:10px;}',
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-label]{flex:1 1 auto;min-width:0;max-width:0;opacity:0;overflow:hidden;color:var(--dsh-anchors-ds-label);font-size:12px;line-height:18px;font-weight:400;text-align:right;white-space:nowrap;text-overflow:ellipsis;pointer-events:none;transition:max-width .16s ease,opacity .12s ease,color .12s ease;}',
    ...
    '[data-dsh-anchors-outline][data-dsh-anchors-style="deepseek"] [data-dsh-anchors-tick]{flex:none;display:block;width:10px;height:2px;border-radius:1px;background:var(--dsh-anchors-ds-tick);transition:height .12s ease,background-color .12s ease;}',
...
function layoutOutline(host, outline) {
  ...
  if (getStyle() === 'deepseek') {
    ...
    outline.style.right = `${Math.max(8, Math.round(window.innerWidth - scrollRect.right + 10))}px`
  } else {
...
function mountAnchors(ctx) {
  ...
  const showTip = (item, title, body, immediate) => {
    ...
    const paint = () => {
      ...
      if (getStyle() === 'deepseek') node.setAttribute('data-overflow', '')
  ...
  const render = () => {
    ...
    for (const anchor of anchors) {
      ...
      item.addEventListener('click', (event) => {
        ...
        if (event.detail === 0 && scrollToAnchor(anchor.key)) flashItem(item)
      })
      ...
      label.textContent = anchor.summary
  ...
  const jumpToIndex = (index) => {
    ...
    if (typeof key === 'string' && scrollToAnchor(key)) flashItem(item)
  }
  ...
  const owningAnchorKey = (scroll, hitKey) => {
    ...
    if (anchorItems.has(hitKey)) return hitKey
    const rows = [...scroll.querySelectorAll('[data-chat-anchor-key]')]
    let owner
    for (const row of rows) {
      const key = row.getAttribute('data-chat-anchor-key')
      if (typeof key === 'string' && anchorItems.has(key)) owner = key
      if (key === hitKey) break
    }
    return owner
  }
  ...
  const lastVisibleAnchorKey = (scroll) => {
    ...
    for (const row of scroll.querySelectorAll('[data-chat-anchor-key]')) {
      const key = row.getAttribute('data-chat-anchor-key')
      if (typeof key !== 'string' || !anchorItems.has(key)) continue
      const rect = row.getBoundingClientRect()
  ...
  const syncActive = () => {
    ...
    const scroll = host.matches('[data-conversation-scroll]')
      ...
      : host.querySelector('[data-conversation-scroll]')
    if (!(scroll instanceof HTMLElement)) return
    const key = owningAnchorKey(scroll, visibleAnchorKey(scroll))
      ?? lastVisibleAnchorKey(scroll)
      ?? railItems().at(-1)?.getAttribute('data-anchor-key')
      ?? undefined
    for (const [anchorKey, item] of anchorItems) {
      const active = anchorKey === key
      if (active) {
...
/** Sessions are required; settings/slots are optional so the rail still mounts. */
const inject = {
  sessions: true,
...
function createStyleRow(React, primitives) {
  ...
  return function StyleRow() {
    ...
    const selectedLabel = style === 'deepseek' ? t('styleDeepseek') : t('styleCodex')
