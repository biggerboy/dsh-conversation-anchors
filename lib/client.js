...
function injectStyle() {
  ...
  style.textContent = [
    ...
    '[data-dsh-anchors-outline]{box-sizing:border-box;position:fixed;left:8px;width:36px;z-index:3;display:flex;flex-direction:column;justify-content:center;align-items:flex-start;margin:0;padding:0;border:0;background:transparent;pointer-events:none;overflow:visible;}',
    ...
    '[data-dsh-anchors-outline] [data-dsh-anchors-item]{box-sizing:border-box;display:flex;align-items:center;width:36px;height:11px;margin:0;padding:0;border:0;background:transparent;cursor:pointer;outline:none;box-shadow:none;-webkit-tap-highlight-color:transparent;}',
    ...
    '[data-dsh-anchors-outline] [data-dsh-anchors-tick]{display:block;width:8px;height:1.5px;border-radius:1px;background:var(--dsh-anchors-tick);transform-origin:left center;transition:width .14s ease,height .14s ease,background-color .14s ease;}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-item][data-active] [data-dsh-anchors-tick]{width:16px;height:2px;background:var(--dsh-anchors-tick-strong);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-active] [data-dsh-anchors-tick]{width:8px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="0"] [data-dsh-anchors-tick]{width:32px;height:2.5px;background:var(--dsh-anchors-tick-strong);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="1"] [data-dsh-anchors-tick]{width:22px;height:2px;background:var(--dsh-anchors-tick-mid);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="2"] [data-dsh-anchors-tick]{width:15px;height:1.5px;background:var(--dsh-anchors-tick-mid);opacity:.85;}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="3"] [data-dsh-anchors-tick]{width:11px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="4"] [data-dsh-anchors-tick]{width:8px;height:1.5px;background:var(--dsh-anchors-tick);}',
    '[data-dsh-anchors-outline] [data-dsh-anchors-list][data-waving] [data-dsh-anchors-item][data-wave="5"] [data-dsh-anchors-tick]{width:6px;height:1.5px;background:var(--dsh-anchors-tick);opacity:.8;}',
    ...
    '[data-dsh-anchors-status]{position:absolute;left:40px;bottom:8px;z-index:4;box-sizing:border-box;max-width:min(280px,calc(100vw - 48px));padding:4px 8px;border-radius:8px;background:var(--dsh-anchors-tip-bg);color:var(--dsh-anchors-tip-body);font-size:12px;line-height:18px;white-space:nowrap;pointer-events:none;box-shadow:var(--dsh-anchors-tip-shadow);}',
